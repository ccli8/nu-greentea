...
mbed test -m NUMAKER_IOT_M263A -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m263a_armc6_no-hxt-lxt_0.log
mbed test -m NUMAKER_IOT_M263A -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m263a_armc6_no-hxt-lxt.log

#mbed test -m NUMAKER_IOT_M263A -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m263a_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NUMAKER_IOT_M263A -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m263a_gcc_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_IOT_M263A -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m263a_iar_no-hxt-lxt_0.log
#mbed test -m NUMAKER_IOT_M263A -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m263a_iar_no-hxt-lxt.log
