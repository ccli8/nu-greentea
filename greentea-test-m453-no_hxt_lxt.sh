...
mbed test -m NUMAKER_PFM_M453 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m453_armc6_no-hxt-lxt_0.log
mbed test -m NUMAKER_PFM_M453 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m453_armc6_no-hxt-lxt.log

#mbed test -m NUMAKER_PFM_M453 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m453_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NUMAKER_PFM_M453 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m453_gcc_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_PFM_M453 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m453_iar_no-hxt-lxt_0.log
#mbed test -m NUMAKER_PFM_M453 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m453_iar_no-hxt-lxt.log
