...
mbed test -m NU_M2354 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m2354-psa-ns_armc6_no-hxt-lxtr_0.log
mbed test -m NU_M2354 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m2354-psa-ns_armc6_no-hxt-lxt.log

#mbed test -m NU_M2354 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m2354-psa-ns_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NU_M2354 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m2354-psa-ns_gcc_arm_no-hxt-lxt.log

#mbed test -m NU_M2354 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m2354-psa-ns_iar_no-hxt-lxt_0.log
#mbed test -m NU_M2354 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m2354-psa-ns_iar_no-hxt-lxt.log
