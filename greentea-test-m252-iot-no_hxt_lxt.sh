...
mbed test -m NUMAKER_IOT_M252 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m252-iot_armc6_no-hxt-lxt_0.log
mbed test -m NUMAKER_IOT_M252 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m252-iot_armc6_no-hxt-lxt.log

#mbed test -m NUMAKER_IOT_M252 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m252-iot_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NUMAKER_IOT_M252 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m252-iot_gcc_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_IOT_M252 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m252-iot_iar_no-hxt-lxt_0.log
#mbed test -m NUMAKER_IOT_M252 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m252-iot_iar_no-hxt-lxt.log
