...
mbed test -m NUMAKER_IOT_M252 -t ARMC6 -n $TEST_LIST > m252-iot_armc6.log
mbed test -m NUMAKER_IOT_M252 -t GCC_ARM -n $TEST_LIST > m252-iot_gcc_arm.log
mbed test -m NUMAKER_IOT_M252 -t IAR -n $TEST_LIST > m252-iot_iar.log
