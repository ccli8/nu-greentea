...
mbed test -m NU_PFM_M2351_NPSA_NS -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m2351-npsa-ns_armc6_no-hxt-lxt_0.log
mbed test -m NU_PFM_M2351_NPSA_NS -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m2351-npsa-ns_armc6_no-hxt-lxt.log

#mbed test -m NU_PFM_M2351_NPSA_NS -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m2351-npsa-ns_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NU_PFM_M2351_NPSA_NS -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m2351-npsa-ns_gcc_arm_no-hxt-lxt.log

#mbed test -m NU_PFM_M2351_NPSA_NS -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m2351-npsa-ns_iar_no-hxt-lxt_0.log
#mbed test -m NU_PFM_M2351_NPSA_NS -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m2351-npsa-ns_iar_no-hxt-lxt.log
