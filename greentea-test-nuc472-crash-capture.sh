...
mbed test -m NUMAKER_PFM_NUC472 -t ARM -n $TEST_LIST > nuc472_arm_crash-capture.log
#mbed test -m NUMAKER_PFM_NUC472 -t uARM -n $TEST_LIST > nuc472_uarm_crash-capture.log
