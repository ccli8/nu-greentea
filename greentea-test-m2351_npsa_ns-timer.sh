...
mbed test -m NU_PFM_M2351_NPSA_NS -t ARMC6 -n $TEST_LIST > m2351-npsa-ns_armc6_timer.log
mbed test -m NU_PFM_M2351_NPSA_NS -t GCC_ARM -n $TEST_LIST > m2351-npsa-ns_gcc_arm_timer.log
mbed test -m NU_PFM_M2351_NPSA_NS -t IAR -n $TEST_LIST > m2351-npsa-ns_iar_timer.log
