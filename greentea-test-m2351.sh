...
mbed test -m NUMAKER_PFM_M2351 -t ARMC6 -n $TEST_LIST > m2351_armc6.log
#mbed test -m NUMAKER_PFM_M2351 -t uARM -n $TEST_LIST > m2351_uarm.log
mbed test -m NUMAKER_PFM_M2351 -t GCC_ARM -n $TEST_LIST  > m2351_gcc_arm.log
#mbed test -m NUMAKER_PFM_M2351 -t IAR -n $TEST_LIST > m2351_iar.log
