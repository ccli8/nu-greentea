...
mbed test -m NUMAKER_PFM_NUC472 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > nuc472_armc6_no-hxt-lxt_0.log
mbed test -m NUMAKER_PFM_NUC472 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > nuc472_armc6_no-hxt-lxt.log

#mbed test -m NUMAKER_PFM_NUC472 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > nuc472_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NUMAKER_PFM_NUC472 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > nuc472_gcc_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_PFM_NUC472 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > nuc472_iar_no-hxt-lxt_0.log
#mbed test -m NUMAKER_PFM_NUC472 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > nuc472_iar_no-hxt-lxt.log
