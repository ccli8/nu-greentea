...
#mbed test -m NUMAKER_IOT_M263A -t ARM -n $TEST_LIST > m263a_arm.log
mbed test -m NUMAKER_IOT_M263A -t ARMC6 -n $TEST_LIST > m263a_armc6.log
mbed test -m NUMAKER_IOT_M263A -t GCC_ARM -n $TEST_LIST > m263a_gcc_arm.log
mbed test -m NUMAKER_IOT_M263A -t IAR -n $TEST_LIST > m263a_iar.log
