...
mbed test -m NUMAKER_IOT_M467 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m467_iot_armc6_no-hxt-lxt_0.log
mbed test -m NUMAKER_IOT_M467 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m467_iot_armc6_no-hxt-lxt.log

#mbed test -m NUMAKER_IOT_M467 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m467_iot_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NUMAKER_IOT_M467 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m467_iot_gcc_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_IOT_M467 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > m467_iot_iar_no-hxt-lxt_0.log
#mbed test -m NUMAKER_IOT_M467 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > m467_iot_iar_no-hxt-lxt.log
