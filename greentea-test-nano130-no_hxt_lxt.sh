...
mbed test -m NUMAKER_PFM_NANO130 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > nano130_arm_no-hxt-lxt_0.log
mbed test -m NUMAKER_PFM_NANO130 -t ARMC6 --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > nano130_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_PFM_NANO130 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > nano130_gcc_arm_no-hxt-lxt_0.log
#mbed test -m NUMAKER_PFM_NANO130 -t GCC_ARM --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > nano130_gcc_arm_no-hxt-lxt.log

#mbed test -m NUMAKER_PFM_NANO130 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --compile > nano130_iar_no-hxt-lxt_0.log
#mbed test -m NUMAKER_PFM_NANO130 -t IAR --app-config mbed_app_no_hxt_lxt.json -n $TEST_LIST --run -v > nano130_iar_no-hxt-lxt.log
